...
class ErrorCode(BaseErrorCode):
    ...
    ERROR_CODE_HTTP_MAP = {
        ...
        MISSING_PLAYER_ID: status.HTTP_400_BAD_REQUEST,
    ...
    def get_string_for_missing_player_id(kwargs: dict):
    ...
    CODE_MESSAGE_MAP = {
        ...
        MISSING_PLAYER_ID: get_string_for_missing_player_id,
