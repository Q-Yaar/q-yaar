"""
S3-compatible object storage helpers (Deuxfleurs/Garage, MinIO, AWS S3, ...).

Thin, synchronous wrapper over the minio client. All access goes through
`get_s3_client()`, which is lazily configured from Django settings.

Object keys are built from parts joined by "/". Answer attachments use:
